...
## Plays positional audio at global position [param at], and from [param from] seconds.[br]
## if [param custom_parent] is set, attempts to add the audio player as a child of [param custom_parent].
